...
/**
* LibraryServer/_ServerFeaturesStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ServerFeaturesInterface.idl
* Thursday, March 7, 2019 at 1:25:45 AM Eastern Standard Time
*/

public class _ServerFeaturesStub extends org.omg.CORBA.portable.ObjectImpl implements LibraryServer.ServerFeatures
{
  ...
  public String listAvailability (String managerID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("listAvailability", true);
                ...
                return listAvailability (managerID        );
            } finally {
                _releaseReply ($in);
            }
  } // listAvailability
  ...
  public String createManager (String managerID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createManager", true);
                $out.write_string (managerID);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
  ...
  public String addToQueue (String userID, String itemID, int numberOfDays)
  {
            ...
            try {
                ...
                return addToQueue (userID, itemID, numberOfDays        );
            } finally {
                _releaseReply ($in);
            }
  } // addToQueue
  ...
  public String validateClient (String clientID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("validateClient", true);
